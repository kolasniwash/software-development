...
;; given a fn that returns a boolean and lon (list n0 n1 ...) produce (list (fn n0) (fn n1) ...) where (fn nx) evaluate to true  
...
(check-expect (filter2 integer? (list 1 2.1 3)) (list 1 3))
